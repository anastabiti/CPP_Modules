...
/*   Updated: 2022/09/19 08:46:14 by atabiti          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "destructor is called (Bureaucrat::GradeTooLowException)" << std::endl;
}
...
{
	if(this->grade <= form.GetexecuteG())
	form.execute(*this);
	std::cout <<  this->grade << "  " << this->name << " executed " << form.GetName() << std::endl;
}